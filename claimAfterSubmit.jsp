		...
		if(request.getParameter("action").equals("approve"))
		    {
		   	...
		   	//connPay=DriverManager.getConnection("jdbc:mysql://10.0.10.62/db_leaveapplication","fleetview","1@flv");
			   //connPay=DriverManager.getConnection("jdbc:mysql://164.68.105.216/db_leaveapplication","fleetview","1@flv");
                connPay=DriverManager.getConnection("jdbc:mysql://164.68.105.216:8080/db_leaveapplication","fleetview","1@flv");
