	...
	ajaxRequest.onreadystatechange = function()
	{
		if(ajaxRequest.readyState == 4)
		{
			...
			if(reslt=="yes")
			{
				...
				alert("BeneficiaryName already present!");
...
<body>	
	...
	<form name="paymententry" method="post" action="insertnetbankdata.jsp" onsubmit="return validate();">
	...
	<td align="right" valign="top" >		
					...
					<td ><input type="text" name="supplier" id="supplier" value="" style='height: 15px;' onkeyup="if (event.keyCode == 27){document.getElementById('NameList').style.display = 'none';} else { getNames(); }" /></td>
					<td>
	...
	<tr>
	 ...
	 <%if(role.equalsIgnoreCase("AccountsAdmin")){ %>
	<tr>
