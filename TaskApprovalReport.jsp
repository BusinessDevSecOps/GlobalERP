...
<tr><td align="center"><font color="black" size="3"><b>Task Status Report </b></font></td></tr>
<tr></tr>
<tr>
<td>
<br>
...
query12="select Empname as User,dotprojectid as UserID,empcode,HodReport as HOD ,Dept as Department,IFNULL((select sum(a.task_duration)  from dotproject.tasks a left join dotproject.user_tasks b on a.task_id=b.task_id  where task_end_date >='"+dt+"' and task_end_date <='"+dt1+"'  and user_id=c.dotprojectid ),0) as Assigned,IFNULL((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' and d.TaskStatus!='Duplicate' ),0) as Submited,IFNULL((select sum(task_duration) from dotproject.user_tasks a left join dotproject.tasks b on  a.task_id=b.task_id where  a.user_id=c.dotprojectid and task_end_date >='"+dt+"' and task_end_date <='"+dt1+"' and b.task_id not in (select distinct(TaskID) from db_GlobalERP.100000taskmaildata where TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' and userid=c.dotprojectid ) ),0) as Missed ,IFNULL((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"'  and d.TaskStatus='Pending' ),0) as Pending,IFNULL(((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskStatus='Approved' and TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' )),0) as Approved ,IFNULL(((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskStatus='Rejected' and TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' )),0) as Rejected from db_GlobalERP.UserMaster c where c.activestatus='Yes' and c.companymasterid=100000 and c.dept like '%"+department+"%' and c.EmpName like '%"+name13+"%'  and (c.HODReport like '%"+name13+"%' OR c.EmpName like '%"+name13+"%' ) order by c.Empname";
...
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datef%>&todate=<%=datet%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Assigned&role=<%=Sesrole2%>"><%=rs.getString("Assigned")%></a></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datef%>&todate=<%=datet%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Submited&role=<%=Sesrole2%>"><%=rs.getString("Submited")%></a></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datef%>&todate=<%=datet%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Missed&role=<%=Sesrole2%>"><%=rs.getString("Missed")%></a></td>
		
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datef%>&todate=<%=datet%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Pending&role=<%=Sesrole2%>"><%=rs.getString("Pending")%></a></td>
		
		
		
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datef%>&todate=<%=datet%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Approved&role=<%=Sesrole2%>"><%=rs.getString("Approved")%></a></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datef%>&todate=<%=datet%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Rejected&role=<%=Sesrole2%>"><%=rs.getString("Rejected")%></a></td>
...
query12="select Empname as User,dotprojectid as UserID,empcode,HodReport as HOD ,Dept as Department,IFNULL((select sum(a.task_duration)  from dotproject.tasks a left join dotproject.user_tasks b on a.task_id=b.task_id  where task_end_date >='"+data11+"' and task_end_date <='"+data12+"'  and user_id=c.dotprojectid ),0) as Assigned,IFNULL((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskEndDate >='"+data11+"' and TaskEndDate <='"+data12+"' and d.TaskStatus!='Duplicate' ),0) as Submited,IFNULL((select sum(task_duration) from dotproject.user_tasks a left join dotproject.tasks b on  a.task_id=b.task_id where  a.user_id=c.dotprojectid and task_end_date >='"+data11+"' and task_end_date <='"+data12+"' and b.task_id not in (select distinct(TaskID) from db_GlobalERP.100000taskmaildata where TaskEndDate >='"+data11+"' and TaskEndDate <='"+data12+"' and userid=c.dotprojectid ) ),0) as Missed ,IFNULL((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskEndDate >='"+data11+"' and TaskEndDate <='"+data12+"'  and d.TaskStatus='Pending' ),0) as Pending,IFNULL(((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskStatus='Approved' and TaskEndDate >='"+data11+"' and TaskEndDate <='"+data12+"' )),0) as Approved ,IFNULL(((select sum(d.AssignedDuration) from db_GlobalERP.100000taskmaildata d where c.dotprojectid=d.userid and TaskStatus='Rejected' and TaskEndDate >='"+data11+"' and TaskEndDate <='"+data12+"' )),0) as Rejected from db_GlobalERP.UserMaster c where c.activestatus='Yes' and c.companymasterid=100000 and c.dept like '%"+department+"%' and c.EmpName like '%"+name13+"%'  and (c.HODReport like '%"+name13+"%' OR c.EmpName like '%"+name13+"%' ) order by c.Empname";
...
%>
	...
	<tr>
			...
			<td style="font-size: 11px; face:san-serif; color:black" align="left"><%=rs.getString("User")%></td>
			<td style="font-size: 11px; face:san-serif; color:black" align="right"><%=rs.getString("UserID")%></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datenew1%>&todate=<%=datenew2%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Assigned&role=<%=Sesrole2%>"><%=rs.getString("Assigned")%></a></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datenew1%>&todate=<%=datenew2%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Submited&role=<%=Sesrole2%>"><%=rs.getString("Submited")%></a></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datenew1%>&todate=<%=datenew2%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Missed&role=<%=Sesrole2%>"><%=rs.getString("Missed")%></a></td>
		
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datenew1%>&todate=<%=datenew2%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Pending&role=<%=Sesrole2%>"><%=rs.getString("Pending")%></a></td>
		
		
		
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datenew1%>&todate=<%=datenew2%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Approved&role=<%=Sesrole2%>"><%=rs.getString("Approved")%></a></td>
<td style="font-size: 11px;" align="right"><a href="TaskDetReport.jsp?userId=<%=UserID%>&fromdate=<%=datenew1%>&todate=<%=datenew2%>&HOD=<%=HOD%>&Dept=<%=Department%>&User=<%=User%>&Status=Rejected&role=<%=Sesrole2%>"><%=rs.getString("Rejected")%></a></td>
