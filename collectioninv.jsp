				...
				while(i!=Integer.parseInt(request.getParameter("checktotal")))
	    		{
	    			if(request.getParameter("check"+i+"")!=null)
	    			{
	    				...
	    				System.out.println("payment voucher ***  "+"unAutho");
	    			 	try
	    			 	{
	    					sql1="INSERT INTO "+session.getAttribute("CompanyMasterID").toString()+"collectioninv (CustomerCode,PaymentVoucherNo,InvNo,InvValue,AmountPaidAgainstThisInvoice,CustSpecifiedInvoice,InvRefNo,TransactionDate,moneyreceiptno) VALUES"+
	    			       			  "('"+mCustomercode+"','unAutho','"+invoiceNumber+"','"+invoiceValue+"','"+amountAgainstInvoice+"','Yes','"+invoiceNumber+"','"+invoiceDate+"',"+mmoneyreceiptno+")";
