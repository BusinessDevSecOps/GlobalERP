...
<%try{
		...
		System.out.println("After request.getParameter(city)");
		System.out.println("city is ===="+city);
		
        if((!request.getParameter("newcity").equalsIgnoreCase("")) && city.equalsIgnoreCase("Select") )
        {
        	...
        	String sql = "select city from "+session.getAttribute("CompanyMasterID").toString()+"citystctryinfo where City = '"+city+"'";
        	ResultSet rs = st4.executeQuery(sql);
        	if(rs.next())
        	{
        		//dnt insert city is already there	
        	}else
        	{
        		System.out.println("in else newcity!=");
	        	String city1 = "insert into "+session.getAttribute("CompanyMasterID").toString()+"citystctryinfo(City,State,Country)values('"+city+"','"+state+"','"+country+"')";
		...
		System.out.println("after alternateNumber.equals()");
		
		if(mobile.equals(""))
		{	
			System.out.println("in mobile.equals()");
			mobile="0";
		}	
		System.out.println("after mobile.equals()");
		//if(mobile1.equals(""))
		//{
		//	System.out.println("in mobile1.equals()");
		//	mobile1="0";
		//}	
		System.out.println("after mobile1.equals()");
		//if(mobile2.equals(""))
		//{	
		//	System.out.println("in mobile2.equals()");
		//	mobile2="0";
		//}		
		System.out.println("after mobile2.equals()");
		...
		if(request.getParameter("update")==null) 
			{
        		...
        		"		Category 	,	TelephoneNo2 ,phone,STDCode,ProspCustAddedOn,Country,comments,PotentialValue,NoOfUnits,Assighnedby,leadRef,Allocatedto) VALUES "+
        		...
        		"    '"+weeklyOffOn+"','"+date+"','"+category+"','"+alternateNumber+"','"+phone+"','"+stdCode+"','"+addedOn+"','"+country+"','"+comments.replaceAll("'"," ")+"',"+
        		...
        		" STDCode='"+stdCode+"',ProspCustAddedOn='"+addedOn+"',country='"+country+"' ,comments='"+comments.replaceAll("'"," ")+"', "+
