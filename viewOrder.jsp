...
if(null!=request.getParameter("inserted")){
	...
	int i=0;
	String groupName="",makeName="",itemCode="",sellingPrice="";
...
<div align="left"  id="cancellingreason" style="position:absolute; margin-top: 1em;font-size: 1.2em"> &nbsp;<textarea name="reasonforcancel"
	align="right" id="search-text" style='width: 430px; height: 130px;'></textarea>
