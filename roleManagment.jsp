...
//alert(inci1);
	...
	ajaxRequest.onreadystatechange = function()
	{
		...
		//	alert(result);
			if(result.trim()=="yes")
			{
			alert("New Role Added Successfully in System");
			}
			else 
			{
				alert("Error in inserting record!!!Pls try again.");
				return false;
			}
			window.location.reload("roleManagment.jsp")			
		} 
	};
...
<tr>
<td><b><a>*</a> Enter Role Name :</b> </td>
<td align="left">
<input type="text" name="rolename" id="rolename" style='height: 15px;' />
</td>
</tr>
<tr>
...
<label for="InsertRecordCoApplicant_First_Name" ><b>Available Menus :</b></label>
</td>
</tr>
...
{
%>
<option value="<%=rs1.getString("MenuID") %>"><%=rs1.getString("MenuName") %></option>
<%
}
%>
</select>
