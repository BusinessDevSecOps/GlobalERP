...
{ 
	window.open(webadd,'jav','width=500,height=350,top=200,left=300,resizable=no');
...
<form name='ledgerDetails' action="addExportSalesEnq.jsp" onsubmit="return validate();" method="post" autocomplete="off">

<script>document.getElementById("dataentry").style.visibility="hidden";</script>
<div id="visitingCard" style="position:absolute; margin-top:7%;margin-left:45%;width:100%;border:thin solid black;background-color:#94ECF6;">
   <table>
   <tr>
	<td align="left" ><div id="Company"><font face="Arial" size="2" color="black"><b>Company :</b></font></div></td>
	<td align="left">
	<div id="companyName">
	...
	<td align="center" style="width: 25%"><div id="Contact"><font face="Arial" size="2" color="black"><b>Contact :</b></font></div></td>
    ...
    <tr>
	<td align="left"><div id="Phone"><font face="Arial" size="2" color="black"><b>Phone</b></font></div>
	</td>
	<td align="left">
	...
	<td align="center" style="width: 25%" valign="middle"><div id="Email"><font face="Arial" size="2" color="black"><b>E-Mail :</b></font></div>
	</td>
	...
	<tr>
	<td align="left"><div id="Product"><font face="Arial" size="2" color="black"><b>Product :</b></font></div>
	</td>
	<td align="left">
	...
	<td align="center" style="width: 25%"><div id=City><font face="Arial" size="2" color="black"><b>City :</b></font></div>
	</td>
	<td valign="top" align="right">
...
<div style="position:absolute;margin-left:0;margin-top;82%;text-align:left;width:100px;height:35x;">
	<table>
	<tr>
	<td>
    ...
    <td><font face="Arial" size="3"><b>Back</b></font>
    </td>
    </tr>
    </table>
</div> 
	<div style="margin-left:30%;border:thin solid black;width:40%;background-color: #D3E5FA;height:40px;"><font face="Arial" size="3" color="black"><b>Sales Enquiry Form</b></font>

</div> <div align="right"><a href="#" onclick="popup1();"><font size="2" color="blue";><u>GO TO SALES MENU</u></font></a></div>
		...
		<table width="100%" border="0">
  			<tr>
  			<td>
  			<div><font face="Arial" size="2" color="black"><b>Customer Name :<font color="red"> *</font></b></font>
  				<input type="text" name="companyNames" onkeyup="getCompanies();" style="width: 250px;"  autocomplete="off" />
 			</div>
			</td>
			<td><font face="Arial" size="2" color="black"><b>Cust Ref No :</b></font>&nbsp;&nbsp;
			<input type="text" name="customerRefNumber" id="search-text"  value='-'  style="width: 125px;" />	
			</td>
			<td><font face="Arial" size="2" color="black"><b>Due Date:</b></font>
	        ...
	        <tr>
	        <td width="400px">&nbsp;&nbsp;<div id='companyList'>
	        ...
	        <td style="width:70;">
	        <font face="Arial" size="2" color="black"><b>Remarks:</b></font>&nbsp;
	        </td>
	        <td>
	        	 <textarea name="remarks"  rows="2" style=" width: 260px; height: 100px;" ></textarea>
	        	 </td>
     		...
     		(+)
      		...
      		<font face="Arial" size="2" color="black"><b>New Entry </b></font><input type="hidden" name="status" id="status" value="" />
...
<div align="center" style="border:thin solid black; font-size: 1.5em; margin-top: 0.4em; margin-bottom: 0.5em; height:225px; width:700;background-color: #D3E5FA;">
		...
		Delete  
		<!-- <a href="#" onclick="checkAll()"> <font color="white">Chk All&nbsp;&nbsp;/&nbsp;</font></a>
