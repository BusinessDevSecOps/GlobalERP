...
function insertrows()
{
	...
	{			
	 ...
	 cell1.innerHTML = "<input type=text id='cpname' name='cpname' style=width:160px; padding:4px 5px 2px 5px; border-color:activeborder; text-align:left; background:#FFFFFF; font:normal 11px Arial, Helvetica, sans-serif; color:#000000;></input>";
...
function validate()
{
  ...
  {	  
   ...
   if(erpcode=="" || erpcustnm=="" || grpcd=="" || group=="" || slaper=="" || rate=="" || stax=="" || scharge=="" || cpname=="")
   {
