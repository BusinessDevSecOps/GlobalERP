...
<body>
	...
	<a>Deactivate Category</a> </div>
	<div align="center" style="margin-left: 20%;">
	
	<form name="paymententry" method="post" action="" >
	...
	<td align="right">		
					...
					<td><input type="text" name="supplier" id="search-text" value=""  />
</td>
	</tr>
	<tr>
					<td align="right"><b>Limit : </b></td>
					<td  align="left"><input type="text" name="accountno" id="search-text"  />
					</td>
	</tr>
