...
<title>Transworld Compressor-Technologies LTD, ERP</title>
	...
	<tr>
		...
		<br></br><br></br>
			...
			<td><b>Enquiry Date :</b><%=new SimpleDateFormat(
			"dd-MMM-yyyy")
			.format(new SimpleDateFormat( 
					"yyyy-MM-dd")
					.parse(rsEnqDet.getString("PurEnqDate")))%> <br></br><br></br>
			<b>Kind Attn: <%=contact %></b>		<br></br><br></br>
			
			<b>Please offer your most competitive rates.</b><br></br><br></br>
			<b>Due Date :</b><%=new SimpleDateFormat(
			"dd-MMM-yyyy")
			.format(new SimpleDateFormat( 
					"yyyy-MM-dd")
					.parse(rsEnqDet.getString("DueDate")))%> <br></br><br></br>
...
purchase@transworld-compressor.com
</div> 
