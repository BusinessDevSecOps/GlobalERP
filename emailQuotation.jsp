...
@import url(jscalendar-1.0/calendar-win2k-1.css);
	...
	<%
		...
		String sqno=request.getParameter("salesenqno1");	
	...
	<div align="center"
		...
		Email Of Quotation</a>
	</div>
	<form method="get" action="sendquotation.jsp"
		onSubmit=" ">
	<input type="hidden" id="salesenqnno" name="salesenqnno" value="<%= sqno%>"/>
	<input type="hidden" id="company" name="company" value="<%= comp%>"/>
	...
	<tr>
			...
			<td align="left"><input type="text"
				...
				value="">s_kapre@transworld-compressor.com</input></td>
	</tr>
	<tr>
			<td><br>
			</td>
