...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
        <title>Tally Conversion - Credit Note Vouchers</title>
</head>
<body>
...
%>
    ...
    <%
        ...
        try {
            ...
            <tr >
            <td colspan="7" ><h1>Converted Data to Tally [CREDIT NOTE]</h1></td>
            </tr>
            <th>Voucher Date</th>
            <th>Voucher No</th>
            <th>Account Name</th>
            ...
            <%
                ...
                String mReference = " ";
                String entrysearch = tally.search_in_tables("SELECT * from "+session.getAttribute("CompanyMasterID").toString()+"tallydata_conv where voucher_no='"+mVoucherno+"' and voucher_type='Credit Note'");
            ...
            xmldoc.append("<VOUCHER  VCHTYPE='Credit Note' ACTION='Create'>\r\n");
            xmldoc.append("<DATE>"+mVoudate+"</DATE>\r\n");
            xmldoc.append("<NARRATION>"+mNarration+"</NARRATION>\r\n");
            xmldoc.append("<VOUCHERTYPENAME>Credit Note</VOUCHERTYPENAME>\r\n");
            ...
            xmldoc.append("<ALTERID> 152647</ALTERID>\r\n");
            ...
            xmldoc.append("<BILLCREDITPERIOD>10 Days</BILLCREDITPERIOD>\r\n");
            xmldoc.append("<SERVICETAXLEDGER>Service Tax (Output)</SERVICETAXLEDGER>\r\n");
            xmldoc.append("<BILLTYPE>Agst Ref</BILLTYPE>\r\n");
            xmldoc.append("<AMOUNT>"+mAmount+"</AMOUNT>\r\n");
            xmldoc.append("</BILLALLOCATIONS.LIST>\r\n");
            xmldoc.append("</ALLLEDGERENTRIES.LIST>\r\n");
            xmldoc.append("<ALLLEDGERENTRIES.LIST>\r\n");
            xmldoc.append("<LEDGERNAME>TDS 2011-12 (Assets )</LEDGERNAME>\r\n");
            xmldoc.append("<GSTCLASS/>\r\n");
            ...
            if (senddata.contains("Updated") && (entrysearch=="NOT FOUND") )
            {
            	sql1="insert into "+session.getAttribute("CompanyMasterID").toString()+"tallydata_conv (voucher_type,voucher_date,voucher_no,accountname,secondaccount,amount,narrations,username,create_date,tallyvid)"+
                     "VALUES ( 'Credit Note','"+mVoudate+"','"+mVoucherno+"','"+mCompanyname+"','"+mSecondname+"','"+mAmount+"','"+mNarration+"','"+mUsername+"','"+todaysDateTime+"','"+senddata+"' )";
