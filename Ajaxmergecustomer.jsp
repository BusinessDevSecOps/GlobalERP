...
String sql1="insert into db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"Customermargehistory(Date,Oldcustomercode,OldCustomername,Newcustomercode,Newcustomername,ReasonForMerge,MergeBy)values('"+todaysdate+"','"+cmpcode+"','"+cmp+"','"+margecode+"','"+margecmp+"','"+otherreason+"','"+entryby+"')";
