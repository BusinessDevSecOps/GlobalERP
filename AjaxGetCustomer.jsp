...
sql1="( SELECT *  from "+session.getAttribute("CompanyMasterID").toString()+"customerdet where companyname like ('"+prospect+"%') order by  companyname )"+
"union"+
"(SELECT *  from "+session.getAttribute("CompanyMasterID").toString()+"customerdet where companyname like ('%"+prospect+"%')  order by  companyname) order by companyname limit 20";
