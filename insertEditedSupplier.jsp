...
String SupProduct="",AreaCode="",mobile="",weekOff="",Designation="",chk="";
...
/*else	sqlInsert = "INSERT INTO "+session.getAttribute("CompanyMasterID").toString()+"supplierdet(	SupplierCode,SupplierName, 	City, 	ContactPerson,Address, 	Zip, 	State,"+
            ...
            System.out.println(sqlInsert);*/
			 	sqlInsert = "UPDATE "+session.getAttribute("CompanyMasterID").toString()+"supplierdet SET 	SupplierCode='"+SupplierCode+"',SupplierName='"+supplierName+"', City='"+city+"',ContactPerson='"+contactPerson+"',	Address='"+address+"', 	"+
			 	" 	Zip='"+zip+"', 	State='"+state+"',Country='"+country+"',	EMail='"+email+"',phone='"+phone+"',	Fax='"+fax+"' ,"+
        		" 	WebSite='"+website+"',Sup_Rating='"+SupRating+"',SupUserName='-',SupPassword='-' ,"+
        		" EnteredOn='"+EnteredOn+"' ,"+
        		"	AreaCode='"+AreaCode+"', "+
        		...
        		"  WHERE SupplierName='"+mainsupllier+"' limit 1";     
...
if(flag){
msg = "Prospect "+supplierName+" saved successfully in system";
}
