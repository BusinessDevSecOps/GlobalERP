...
//		alert(document.getElementById("EmpNames").value);
	...
	{ 
		...
		if(document.addFolloUp.companyNames.value=="" || document.addFolloUp.companyNames.value==null)
			...
			window.open('customerDetails.jsp'+'?companyName='+document.addFolloUp.companyNames.value.replace('&','~')+'&type='+document.addFolloUp.custType.value,'jav','width=750,height=700,top=30,left=300,resizable=yes');
	}
	...
	<td>					
							...
							<table id="BtnLabels" border="0" style="display: none;" cellpadding="5" cellspacing="5">
								...
								<tr>
									<td align="left" valign="top">
									<div><a href="#"
										onClick="showFollowUpEntryForm('followupEntryForm.jsp');return false "><input
										type="button" id="search-submit" name="followUp"
										style="width: 130px;height:25px;background-color: #C6DEFF;border: medium;font-size: small;text-align: left;font: bold;cursor: pointer;" value="Follow-Up      "
										onclick="<%FollowUpType = "Pros";%>"  /></a></div> 
									</td>
								</tr>
								<tr>
								<% if((session.getAttribute("CompanyType").toString().equalsIgnoreCase("Transport"))){%>
	...
	font: bold;cursor: pointer;" name="EditNewCustomer" value="Edit" /></a>
			...
			<tr>
									<td align="left"><a href="#"
										onclick="customerDetails();"><input type="button"
