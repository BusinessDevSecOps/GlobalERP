...
<%
	...
	if (item.isFormField()) {
		...
		try {
			...
			if (itemName.equalsIgnoreCase("")) {
				...
				//savedFile = new File("/home/twtech/esslattendence/" + itemName);
	...
	/* try { */
		...
		String MM_dbConn_STRING = "jdbc:mysql://164.68.105.216:3306/db_gps";
		//String MM_dbConn_STRING = "jdbc:mysql://172.16.8.17";
	...
	e.printStackTrace();
		...
		//String fname = "/home/twtech/esslattendence/" + file1;
		...
		String dattime=employee[3];
		System.out.println("dattime lellllllllll :" + dattime.length());
		if(dattime.length()==9){
		attdate = new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("dd-MMM-yy").parse(employee[3]));
		}else{
			attdate = new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("dd-MMM-yyyy").parse(employee[3]));
		}

		System.out.println("attdate   iiiiiii : "+attdate);
