...
public class DemoRequest {
	...
	//	PdfWriter writer=PdfWriter.getInstance(document, buffer);
		...
		String srt="I/We XXXXXX (“Company”) am/are interested in the above products and request you for a Demo of the above products at XXXXX location. Date:XXXXX Duration: XXXXX days. No. of demo units XXXXX. " +
