...
String webadd="ledgerdetails.jsp?companyName="+company.replace('&','~')+"&companyPerson="+companyPerson+"&companyPhone="+companyPhone+"&companyEmail="+companyEmail+"&companyCity="+companyCity+"&companyProduct="+companyProduct;
