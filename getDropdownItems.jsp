...
if(request.getParameter("group")!=null)
{
	...
	//	tableName="tbl_otherim_group"+groupCode;
	
	tableName=session.getAttribute("CompanyMasterID").toString()+"tbl_"+groupName.substring(0,5)+"makemaster";
	
		 sql1="SELECT distinct(MakeName), MakeCode from "+tableName.toLowerCase()+" group by MakeName";
		   System.out.println(sql1);
		   rs1=stmt1.executeQuery(sql1);
		   while(rs1.next())
		   {
		      flag=true;
		      buffer+="<option value='"+rs1.getString(1)+"::"+groupCode+"::"+groupName+"::"+rs1.getString(2) +"'>"+rs1.getString(1)+"</option>";
		        i++;
		   } 
	}
...
else if(request.getParameter("description")!=null && request.getParameter("newglobal")!=null)
{
	...
	//System.out.println("des before conversion####  "+des);
	//des = des.replaceAll("\\^\\^","+");
	//System.out.println("des after conversion####  "+des);
