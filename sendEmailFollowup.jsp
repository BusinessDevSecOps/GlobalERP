	...
	HSSFCell cell = null;
	  int rowcnt = 2;
		  ...
		  String arr[] = { "Sr.No", "Tr Date","Tr Id.", "Debit", 
			"Credit", "Balance(o/s)", "Voucher no.","Desc" ,"Sign" };
...
htmlString = htmlString+"<table border=1 align=center width=100% cellpadding=0 cellspacing=1>";
			htmlString = htmlString+"<tr><td align=left style=background-color:#FFFF00>Sr.No</td><td align=center style=background-color:#FFFF00>Tr.Date</td><td align=center style=background-color:#FFFF00>Tr. Id</td><td align=center style=background-color:#FFFF00>Debit</td><td align=center style=background-color:#FFFF00>Credit</td><td align=center style=background-color:#FFFF00>Balance(o/s)</td><td align=center style=background-color:#FFFF00> Voucher No. </td><td align=center style=background-color:#FFFF00>Desc </td><td align=center style=background-color:#FFFF00>Sign </td></tr> ";
			...
			htmlString+="<tr><td align='left'>1</td>"+
	 	"<td align='right'>"+fromDateFormat +"</td><td>  Opening Balance </td><td align='left'> "+credit+" </div></td> 	<td align='left'>"+debit+" </div></td>"+
	 	"<td> "+openingBalance+"</div></td><td>  --- </td><td>  --- </td><td>  --- </td></tr>";
	 	
	 	
		row = sheet.createRow(3);
		row.setHeightInPoints(12.75f);
		 String ar[] = { "", fromDateFormat,"Opening Balance", "0.00", 
					"0.00", openingBalance, "-","-" ,"-" };
...
while (rsDetails.next()) {
	...
	htmlString = htmlString+"<tr><td align=right>"+i+" </td> "+
			...
			"<td align=right>"+rsDetails.getString("TransactionDetail")+"</td>" +
			...
			"<td align=right>"+rsDetails.getString("PaymentVoucherNo")+"</td>" +
			"<td align=left> "+rsDetails.getString("TransactionType")+" </td>" +
			"<td align=left>"+rsDetails.getString("EmpName")+"</td></tr>" ;
			
			
			try {
 
				String  arr1[] = { ""+i,frmt.format(prse.parse(rsDetails.getString("TransactionDate"))),
						rsDetails.getString("TransactionDetail"),
						rsDetails.getString("DebitAmount"), creditAmt,
						rsDetails.getString("Balance"), rsDetails.getString("PaymentVoucherNo"),rsDetails.getString("TransactionType"),
...
htmlString = htmlString+"<tr>"+
	"<td colspan='3' style='background-color: #C6DEFF;' >Total:"+  
	  "</td>"+
	"<td style='background-color: #C6DEFF;'  > "+s1 +"</div></td>"+
	"<td style='background-color: #C6DEFF;'  > "+s2 +"</div></td>"+
	"<td style='background-color: #C6DEFF;'  > "+rsDetails.getString("Balance") +"</div></td>"+
	"<td colspan='3' style='background-color: #C6DEFF;' > .</td></tr>";  
	
String arr4[]={"Total","","",s1,s2,rsDetails.getString("Balance")};
row = sheet.createRow(++rowcnt);
row.setHeightInPoints(12.75f);
