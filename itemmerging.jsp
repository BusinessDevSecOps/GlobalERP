...
function getCompanies(prospect)
{
	try{
		...
		var company=document.getElementById("itemNames").value;
...
//		alert(timer);
		...
		ajaxRequest.onreadystatechange = function()
		{
			if(ajaxRequest.readyState == 4)
			{
				...
				document.getElementById("itemList").innerHTML=reslt;
				var b=document.getElementById("element").value;
				document.mergeitem.counter.value=b;
				document.mergeitem.counter.value=b*document.mergeitem.counter.value;
				counter=document.mergeitem.counter.value;
			} 
		}
		...
		ajaxRequest.open("GET", "Ajaxmergeitem.jsp" + queryString, true);
...
function getCompanies1(prospect)
{
	...
	//alert("Procept is " +prospect);
		document.getElementById("itlist1").style.display="";
	    document.getElementById("itemList1").style.visibility="visible";
	    
	   // alert("hi");
		var company=document.getElementById("mergename").value;
		 var counter=document.getElementById("counter1").value;

		//var company=document.mergeitem.companyNames.value;
		//alert("hi");
	    //var counter=document.mergeitem.counter.value;alert("hi");
    	//alert(">>>>>>>>>>   "+counter);
...
//		alert(timer);
		...
		ajaxRequest.onreadystatechange = function()
		{
			if(ajaxRequest.readyState == 4)
			{
				var reslt=ajaxRequest.responseText;
				//alert("Result is" +reslt);
				document.getElementById("itemList1").innerHTML=reslt;
				var b=document.getElementById("element").value;
				document.mergeitem.counter1.value=b;
				document.mergeitem.counter1.value=b*document.mergeitem.counter1.value;
				counter=document.mergeitem.counter1.value;
			} 
		}
		...
		ajaxRequest.open("GET", "Ajaxmergeitem1.jsp" + queryString, true);
		ajaxRequest.send(null); 
		
}


function getItemDetails1(i) 
{   
	document.getElementById("itemList1").style.visibility="hidden";
	document.getElementById("itlist1").style.display="none";
//alert(	document.getElementById("mergename").value=document.getElementById("Name"+i).value);
	...
	document.getElementById("mergename").value=document.getElementById("srname"+i).value;
	document.getElementById("gCode").value=document.getElementById("gcode"+i).value;
	document.getElementById("gname").value=document.getElementById("gname"+i).value;
	document.getElementById("mcode").value=document.getElementById("mcode"+i).value;
	document.getElementById("itemCode").value=document.getElementById("icode"+i).value;
	document.getElementById("partno").value=document.getElementById("partno"+i).value;
	document.getElementById("price").value=document.getElementById("price"+i).value;
...
//try{
	...
	var maincode=document.getElementById("itemCode").value;
...
{
	alert("Select proper merging item name");
	return false;
}
else{
...
if(a=="")
{
	alert("Please select item for merging");
	return false;
}
 		...
 		if(save!=null)
{
	...
	window.location="itemmerging.jsp";
...
<form id="mergeitem" action="Ajaxmergeitemfinal.jsp" method="get" onsubmit="return mychkbx();">
					
				<div id="dataentry" align="center"  style="margin-left:10%; width:80%;  background-color: #E1F3F3; border: solid thin black;">
		<div style="border: thin solid blue; background-color: #457FC2; height: 40px; ">
		
		
		<table style="color: white; align: center; width: 90%">
		<tr style="color: white; text-align: center;">
				<td style="width: 80%; color: ">
				
				<font face="Arial" size="3" color="white" ><b>Merge Item
				</b></font></td>
				</tr>
				</table>
				</div>
				<div style="margin-left: 25%;width: 100%">
					<table style="font-size:small" border="0" align="center" width = "100%" >
						<tr>
							...
							<font face="Arial" size="2" color="black"><b>Search Item :</b></font>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="itemNames" id="itemNames" value="" style='width: 350px; font-size: 15px;' onkeyup="timer()" autocomplete="off" />
						...
						<tr id = "itlist"  style="display:none;" >
						<td valign="top"   colspan="1" style="text-align: center;margin-left:16%;" >
						<div align="center" style="border: thin;margin-right: 65%"> 
						<div id='itemList' style="background-color: white;height: 250px; width: 550px; overflow: auto; border:solid inset;" align="center">
	    	...
	    	<input type="text" name="mergename" id="mergename" value="" style='width: 350px; font-size: 15px;' onkeyup="timer1()" autocomplete="off" />
						...
						<tr id = "itlist1"  style="display:none;" >
						
						<td valign="top"   colspan="1" style="text-align: center;margin-left: 16%;" >
						<div align="center" style="border: thin;margin-right: 65%"> 
						<div id='itemList1' style="background-color: white;height: 250px; width: 550px; overflow: auto; border:solid inset;" align="center">
						...
						<%
					String sqlR = "select Reason from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"ReasonForMerge where Category='Item'";
