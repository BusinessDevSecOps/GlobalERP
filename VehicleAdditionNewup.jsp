...
function getdata(vehregno,trans,vehiclecode,i,previousyear,fpreviousmonth)//trans is the ownername
{
	...
	catch (e)
	{
	 ...
	 ajaxRequest.onreadystatechange = function()
	 {
	          ...
	          ajaxRequest.open("GET", "updateVehiclesup.jsp" + queryString, true);
...
<%
String sqlNew="CREATE TABLE IF NOT EXISTS "+session.getAttribute("CompanyMasterID").toString()+"fv_erp_relation"+previousyear+"_"+fpreviousmonth+" like "+session.getAttribute("CompanyMasterID").toString()+"fv_erp_relation"+ppreviousyear+"_"+fppreviousmonth;
