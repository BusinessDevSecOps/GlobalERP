...
<div class="container-fluid">
 ...
 <b></b>
        ...
        <form role="form" action="TaskNextKRA.jsp" id="newModalForm" name="form1" method="post" enctype="multipart/form-data">
 ...
 */       
 ...
 query12="select c.EmpName as User ,c.KRAdotprojectid as UserID,a.task_id as TaskId,a.task_name as TaskName,a.task_duration as Duration,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate  from dotproject.tasks a left join dotproject.user_tasks b on a.task_id=b.task_id left join db_GlobalERP.UserMaster c  on c.KRAdotprojectid=b.user_id where task_end_date >='"+dt+"' and task_end_date <='"+dt1+"'  and c.EmpName like '%"+name13+"%' and a.task_id not in (select distinct(TaskID) from db_GlobalERP.100000taskmaildata where TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' and userid=c.KRAdotprojectid)  and c.dept like '%"+department+"%'";
	System.out.println("query12---"+query12);
			rs=stmt.executeQuery(query12);
 ...
 */        	
 ...
 query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,b.TaskAttachment as TaskAttachment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.KRAdotprojectid where  b.userid in (select KRAdotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus!='Duplicate'  and dept like '%"+department+"%' order by b.taskid";
 ...
 */    	
 ...
 query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskAttachment as TaskAttachment,b.TaskComment as TaskComment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.KRAdotprojectid where  b.userid in (select KRAdotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus!='Duplicate'  and dept like '%"+department+"%' order by b.taskid";
 ...
 */
 ...
 query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,b.TaskAttachment as TaskAttachment,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.KRAdotprojectid where  b.userid in (select KRAdotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus like '%"+Status+"%'  and dept like '%"+department+"%' order by b.taskid";
