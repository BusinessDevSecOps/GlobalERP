...
<td><select name="ourcompany" id="ourcompany" style="width:250px; height: 20px;" class="select">
<%
  ...
  {
	  %>
	 <option value="<%=rsCompany.getString("OurCompanyName") %>"><%=rsCompany.getString("OurCompanyName") %></option>
	  <%
  }
%>
</select>
...
<tr>
	...
	<td colspan="5" align="left"><input type="file"  name="uploadBill" id="uploadBill" class="input" />
	</td>
</tr>
...
if(action.contains("update")||action.contains("-"))
{
	...
	{ 
		if(id.contains("-"))
			         { %>
					  <td>
					  <a href="#" style="font-weight: bold; color: blue; " onclick="popup('ItemClaimInsert.jsp','<%=CLMRefNumber %>');">&nbsp;&nbsp;<font size="3" ><img src="images/add5.jpeg" width="25px" height="25px" title="Open Claim Detail Form" /></font></a>[click hear for claim details]
					  </td>       		
				   <%}
		else{%>	<td>
						<a href="#" style="font-weight: bold; color: blue; " onclick="popupNewWindow('ItemClaimInsert.jsp','<%=claimtype %>','<%=id %>');">&nbsp;&nbsp;<font size="3" ><img src="images/add5.jpeg" width="25px" height="25px" title="Open Claim Detail Form" /></font></a>[click hear for claim details]
						</td>       		
			<%}
}	
%></tr>
...
<br><br>
<div id="footer">
<p><a href="http://www.192.168.2.133"> Copyright &copy; 2009 by Transworld Compressor Technologies Ltd. All Rights Reserved.</a></p>
</div>
</body>
</html>
</jsp:useBean>