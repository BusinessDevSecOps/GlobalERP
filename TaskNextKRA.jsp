...
if(rs.next())
    ...
    // System.out.println("Calculated Task Duration:- "+task_duration1);
     ...
     try
     {
  	   String check="select * from db_GlobalERP.100000taskmaildata where TaskID='"+TaskID1+"' order by MailDateTime desc ";
...
/*   		   String updatestatus1="update db_GlobalERP.100000taskmaildata set TaskStatus='"+updatestatus+"',TaskPercent='"+percent+"',TaskComment='"+comment+"',TaskAttachment='"+file+"' where TaskID='"+TaskID+"' and MailDateTime='"+MailDateTime+"' ";
 */  
 
 
 String checkm="select * from db_GlobalERP.100000taskmaildata where TaskID='"+TaskID1+"' order by MailDateTime desc ";
  ...
  //System.out.println("RSCHECKM1 IS------->>" + checkm);
   ...
   String updatestatus1="update db_GlobalERP.100000taskmaildata set TaskStatus='"+updatestatus+"',TaskPercent='"+other123+"',TaskComment='"+comment1+"',TaskAttachment='"+itemName2+"' where TaskID='"+TaskID1+"' and MailDateTime='"+MailDateTime+"' ";
