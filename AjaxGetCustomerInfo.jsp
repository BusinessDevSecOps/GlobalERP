...
String rep="",code="",contact="",email="",city="",name="",mobile="",product="",off="",website="",fax="",noofunits="", custType = "",custType1 = "",Assighnedby = "", leadRef = "",AddedOnDate = "";
