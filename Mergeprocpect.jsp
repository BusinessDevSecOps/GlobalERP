...
else if(comment=="Other" && (other=="" || oth==""))
{
	...
	document.getElementById("save").value=a;
	 // window.location="AjaxMergeProspect.jsp?save="+a+"&mergename="+mainname+"&comment="+comment+"&other="+other+"&companyCode="+maincode;
}    
...
<form id="mergeprocpect" action="AjaxMergeProspect.jsp" method="get" onsubmit="return mychkbx();" >
		...
		<tr style="color: white; text-align: center;">
				...
				<font face="Arial" size="3" color="white" ><b>Merge Prospect
				</b></font></td>
				</tr>
				</table>
				</div>
				<div style="margin-left: 25%;width: 100%">
					<table style="font-size:small" border="0" align="center" width = "100%" >
						<tr>
							...
							<font face="Arial" size="2" color="black"><b>Search Prospect :</b></font>
							&nbsp;&nbsp;&nbsp;&nbsp;
						
		<input type="text" name="companyNames" id="companyNames" value="" style='width: 40%; font-size: 15px;' onkeyup="timer()" autocomplete="off" />
						...
						<div align="center" style="border: thin;margin-right: 32%"> 
	    	...
	    	<input type="text" name="mergename" id="mergename" value="" style='width: 350px; font-size: 15px;' onkeyup="timer1()" autocomplete="off" />
						...
						<td valign="top"   colspan="1" style="text-align: center;margin-left: 100px;" >
						<div align="center" style="border: thin;margin-right: 32%"> 
						...
						<%
					String sqlR = "select Reason from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"ReasonForMerge where Category='Prospect'";
