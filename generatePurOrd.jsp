...
<div align="center"	style="font-size: 1.5em; margin-top: 0.6em; height: 3px; background-color: #339CCB">
	...
	<%
	String sqlDet="SELECT * from "+session.getAttribute("CompanyMasterID").toString()+"purchasequo as a left outer join "+session.getAttribute("CompanyMasterID").toString()+"supplierdet  as b on (a.SupplierCode=b.SupplierCode ) where  a.PurQuoNo='"+pquono+"' ";
...
<table border="1px"  class="sortable">
	...
	int p=1 ;		
	String Sql="";
	String sqlEnq="SELECT * FROM "+session.getAttribute("CompanyMasterID").toString()+"pquo_items WHERE PQNo='"+pquono+"'";
