...
<script>
function demoo(datenew1,datenew2,HOD,Dept,User,Status,Role,TaskName,UserID,TaskId)
{
 	//alert("DEMO:");
 	//alert(datenew1);
 ...
 */
	...
	document.getElementById('datenew11').value = datenew1;
	
    document.getElementById('datenew21').value = datenew2;
...
<div class="modal fade" id="addMyModall" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
       <div align="center">
        ...
        UserID:<input type="text" id="usrid11" readonly="readonly" style="width: 25%;border: none; font-weight:bold;">&nbsp;&nbsp;&nbsp;<br>
...
<div class="container-fluid">
 ...
 <b></b>
        ...
        <form role="form"  id="newModalFormm" name="form11" method="post" >
        	<input type="hidden"  name="datefrom" id="datefrom" ></input>
                	<input type="hidden"  name="dateto" id="dateto" ></input>
                        	...
                        	<input type="hidden"  name="stst" id=""stst"" ></input>
   ...
   <table border="1" >
      ...
      <textarea id="comments311"  name="comments311" rows="5" cols="30"  placeholder="Description" require></textarea><br></br>
         ...
         <tr>	       
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-success" id="btnSaveIt1" onclick="return approve11()" ">Save</button>
         ...
         <td bgcolor="#f5f5f5" align="center"><font size="2"><b>Status</b></font></td>
           <td bgcolor="#f5f5f5" align="center"><select name="status" id="status" style="width: 100px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; border-color: activeborder;">
            ...
            String sql14="";
            	...
            	sql1="select distinct(TaskStatus) as status from db_GlobalERP.100000taskmaildata where TaskStatus!='Duplicate'";
 ...
 */
 ...
 query12="select c.EmpName as User ,c.dotprojectid as UserID,a.task_id as TaskId,a.task_name as TaskName,a.task_description as task_description,a.task_duration as Duration,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate  from dotproject.tasks a left join dotproject.user_tasks b on a.task_id=b.task_id left join db_GlobalERP.UserMaster c  on c.dotprojectid=b.user_id where task_end_date >='"+dt+"' and task_end_date <='"+dt1+"'  and c.EmpName like '%"+name13+"%'  and c.dept like '%"+department+"%'";
			...
			<tr>
						...
						<%        	if(Sesrole2.equals("AllAdmin") || Sesrole2.equals("HOD"))
						{%>
												<td style="font-size: 11px; face:san-serif; color:black" align="right"> <a data-toggle="modal" href="#addMyModall" onclick="return demoo('<%=datenew1%>','<%=datenew2%>','<%=HOD%>','<%=department%>','<%=rs.getString("User")%>','<%=Status%>','<%=Role%>','<%=rs.getString("TaskName")%>','<%=rs.getString("UserID")%>','<%=rs.getString("TaskId")%>')"><%=rs.getString("TaskId")%></a></td>
 ...
 %>
        ...
        {
/*         	query12="select c.EmpName as User ,c.dotprojectid as UserID,a.task_id as TaskId,a.task_name as TaskName,a.task_duration as Duration,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate  from dotproject.tasks a left join dotproject.user_tasks b on a.task_id=b.task_id left join db_GlobalERP.UserMaster c  on c.dotprojectid=b.user_id where task_end_date >='"+dt+"' and task_end_date <='"+dt1+"'  and c.EmpName like '%"+name13+"%' and a.task_id not in (select distinct(TaskID) from db_GlobalERP.100000taskmaildata where TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' and userid=c.dotprojectid)  and c.dept like '%"+department+"%'";
 */       
 
 query12="select c.EmpName as User ,c.dotprojectid as UserID,a.task_id as TaskId,a.task_name as TaskName,a.task_description as task_description,a.task_duration as Duration,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate  from dotproject.tasks a left join dotproject.user_tasks b on a.task_id=b.task_id left join db_GlobalERP.UserMaster c  on c.dotprojectid=b.user_id where task_end_date >='"+dt+"' and task_end_date <='"+dt1+"'  and c.EmpName like '%"+name13+"%' and a.task_id not in (select distinct(TaskID) from db_GlobalERP.100000taskmaildata where TaskEndDate >='"+dt+"' and TaskEndDate <='"+dt1+"' and userid=c.dotprojectid)  and c.dept like '%"+department+"%'";
        	System.out.println("query12---"+query12);
			rs=stmt.executeQuery(query12);
...
<%-- 						<td style="font-size: 11px; face:san-serif; color:black" align="right"><%=rs.getString("TaskId")%></td>
 ...
 <a data-toggle="modal" href="#addMyModal" onclick="return demo('<%=datenew1%>','<%=datenew2%>','<%=HOD%>','<%=department%>','<%=rs.getString("User")%>','<%=Status%>','<%=Role%>','<%=rs.getString("TaskName")%>','<%=rs.getString("UserID")%>','<%=rs.getString("TaskId")%>')"><%=rs.getString("TaskId")%></a></td>
						...
						<td style="font-size: 11px; face:san-serif; color:black" align="left"><%=rs.getString("TaskName")%></td>
												<td style="font-size: 11px; face:san-serif; color:black" align="left"><%=rs.getString("task_description")%></td>
...
/*         	query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.dotprojectid where  b.userid in (select dotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus!='Duplicate'  and dept like '%"+department+"%' order by b.taskid";
 */        	
        	
 query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_description as task_description,a.task_duration as Duration,b.TaskAttachment as TaskAttachment,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.dotprojectid where  b.userid in (select dotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus!='Duplicate'  and dept like '%"+department+"%' order by b.taskid";
 ...
 */
 ...
 query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_description as task_description,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,b.TaskAttachment as TaskAttachment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.dotprojectid where  b.userid in (select dotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus like '%"+Status+"%'  and dept like '%"+department+"%' order by b.taskid";  	
 ...
 */    	
 ...
 query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_description as task_description,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskAttachment as TaskAttachment,b.TaskComment as TaskComment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status  from dotproject.tasks a join db_GlobalERP.100000taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.dotprojectid where  b.userid in (select dotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid=100000 and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid=100000 and c.activestatus='Yes' and b.TaskStatus!='Duplicate'  and dept like '%"+department+"%' order by b.taskid";
