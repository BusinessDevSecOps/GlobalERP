...
<body>
        ...
        Writer output = null;
        String text = "";
        File file = new File("C:\\Documents and Settings\\Shekhar\\Desktop\\Receipts.xml");
        ...
        <table border="2">
            ...
            while(rs.next()) {
                ...
                String mBankname="Hdfc Bank A/c No 00070330003338";//"HDFC Bank"; // FOR OTHER BANKS WE HAVE MAKE CHANGES IN OUR ERP
            ...
            output.write(text);
            text = "<VOUCHER VCHTYPE='Receipt' ACTION='Create'>\r\n";
            output.write(text);
            ...
            output.write(text);
            //text = "      <GUID>534280e0-8c06-11d9-a6f7-525405f8aba3-00014e78</GUID>\r\n";
            // output.write(text);
            text = "<NARRATION>"+mNarration+"</NARRATION>\r\n";
            //text = "      <NARRATION>Ch. No. :622890 of Deutsche Bank dtd 24.08.2011 Mumbai, deposited through CMS at Pune. (SMR020911002)</NARRATION>\r\n";
            output.write(text);
            text = "      <VOUCHERTYPENAME>Receipt</VOUCHERTYPENAME>\r\n";
            output.write(text);
