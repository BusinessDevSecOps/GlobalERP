...
<%
	...
	try{	
		...
		String sql="INSERT INTO "+session.getAttribute("CompanyMasterID").toString()+"salesorder_det (SalesOrderNo ,SalesQuoNo,	CustSalesOrderNo,CustomerCode, "+ 
				...
				"'0.00','"+addresscode+"','"+company+"','"+cperson1+"' ,"+
	...
	st.executeUpdate(sql);	
		...
		response.sendRedirect("alertGoTo.jsp?msg=Sales Order added successfully with Order No: "+salesorderrefno+" For Company: "+company+" .This will redirect you to print Order .&goto=printSalesOrder.jsp?salesOrder="+sono+"");
	}
	catch(Exception e)
	{
