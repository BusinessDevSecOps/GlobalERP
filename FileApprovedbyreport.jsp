...
%>
	...
	<a>File Approved By Report</a></div>
...
<table width="70%" border="0" align="center">
	...
	<!-- 	<td><b>Entered By</b></td><td align="left"  style="width: 80px;">
		<input type="text" name="EntryName" readonly="readonly" id="EntryName" value=""></input>
		</td>
	 -->
	  ...
	  <td valign="top" align="right" width="25%">
					<div id='repName'>
										 ...
										 <b>File Approved By Name </b></td><td valign="top" align="left" width="25%"><select
...
try 	
{
	//sql1="Select * from "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords where  ApprovedBy='"+user+"' and ApprovedDateTime between '"+fromDate+" 00:00:00' and '"+toDate+" 23:59:59'";
	
	
	if(selectedName.equalsIgnoreCase("All"))
	{
		sql1="Select * from "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords where   ApprovedDateTime between '"+fromDate+" 00:00:00' and '"+toDate+" 23:59:59'";
	}
	else
	{
		sql1="Select * from "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords where  ApprovedBy='"+selectedName+"' and ApprovedDateTime between '"+fromDate+" 00:00:00' and '"+toDate+" 23:59:59'";
	}
...
<td><div align="left"><%=rsdata.getString("ApprovalComments") %> </div></td>
<td><div align="left"><%=rsdata.getString("ApprovedBy") %> </div></td>
