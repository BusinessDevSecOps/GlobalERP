...
@import url(jscalendar-1.0/calendar-win2k-1.css);
	...
	<%
			...
			String CustPaymentMode="-", 	STDCode="-", 	MobileNo="-", 	ResiNo="-", 	TelephoneNo2="-", 	VendorCod="-";
	%>
	<%
...
try {
	...
	{
				//code for customer
				String sql="SELECT * from "+session.getAttribute("CompanyMasterID").toString()+"customerdet where CompanyName = '"+companyName+"' limit 1";
				System.out.print(sql);
				ResultSet rs=st.executeQuery(sql);
				if(rs.next())
				{
