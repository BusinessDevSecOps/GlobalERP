...
%>     
	...
	<div align="right" style="background-color:#C6DEFF;margin-left:90%;margin-right:0%;  height:380px;width: 150px;position: absolute;">
        ...
        <li><a href="#" style="background-color:#3399FF">Tools</a>
           <ul>
           <li><a href="transporterData.jsp">Update TransporterData</a></li>
          <li><a href="VehicleAddition.jsp">Configure New Vehicles</a></li> 
         <li><a href="vehiclebillreport.jsp">Billing Detail Report</a></li> 
         <li><a href="autogeneratedbillreport.jsp">Monthly Billing Generation Report</a></li>
           </ul>
        </li>
