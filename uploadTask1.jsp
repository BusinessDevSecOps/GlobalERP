...
try{	   
        		...
        		try {
					...
					//	String MM_dbConn_GPS = "jdbc:mysql://173.234.153.82/dotproject";
					  String MM_dbConn_GPS = "jdbc:mysql://164.68.105.216/dotproject";//means 138*******
       		...
       		// Iterates the data and print it out to the console.	
			        for (int i = 1; i < sheetData.size(); i++) {
						...
						try
						{
							...
							Description = stringTokenizer.nextToken();		//optional field
							...
							System.out.println("Duration  is :**"+twoDForm1.format(duration1));
						...
						try{	
							...
							{							
								cnt++;
								String sql ="insert into dotproject.tasks(task_id,task_name,task_parent,task_project,task_owner,task_start_date,task_duration,task_end_date,task_description,task_creator,task_percent_complete)values('"+newtaskid+"','"+task+"','"+newtaskid+"','"+project+"','"+userid+"','"+frmDate+"','"+task_duration+"','"+toDate+"','"+Description+"','"+userid+"','"+task_percent_complete+"')";	
							...
							{	cnt++;
								String sql ="insert into dotproject.tasks(task_id,task_name,task_parent,task_project,task_owner,task_start_date,task_duration,task_end_date,task_description,task_creator)values('"+newtaskid+"','"+task+"','"+newtaskid+"','"+project+"','"+userid+"','"+frmDate+"','"+task_duration+"','"+toDate+"','"+Description+"','"+userid+"')";
								System.out.println("The query is :"+sql);
								st.execute(sql);
				...
				//File f = new File("/home/user/Desktop/TaskReport/"+file1);
        ...
        //=======================================================================
        		System.out.println("msgpgflgmsgpgflg :- !"+msgpgflg);
        if(msgpgflg==true)	
        ...
        if(msgpgflg==false)
        {
          ...
          response.sendRedirect("alertGoTo.jsp?msg=Please Upload Standard Format!!&goto=uploadTask.jsp");
