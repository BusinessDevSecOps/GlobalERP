...
<%
	...
	{	
		...
		/**********************************************************************************************/
		//congps = DriverManager.getConnection("jdbc:mysql://164.68.105.216:3306/db_gps","fleetview","1@flv");
		/*********************************************************************************************/
		...
		//vehid++;
	    /********************************************************************************/
		String sqlData="select * from "+session.getAttribute("CompanyMasterID").toString()+"fv_erp_relation"+year+"_"+month+" where Groupname='"+group+"' and (sc>0 or st>0) Order By Vehid Desc Limit 1";
