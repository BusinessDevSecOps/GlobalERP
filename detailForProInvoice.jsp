...
<form name="order" method="post" action="ReviseProInvoice.jsp" onsubmit="return validate();">
   <div align="center" style="font-size: 1.5em; margin-top: 0.3em;   height: 3px; background-color: #339CCB">
	...
	<div align="center" style="margin-top:0.3em;  margin-bottom:0.3em; font-size: 1.5em;"> Sales Invoice :<a><%=invcrefno%></a></div>
		<div align="center"
		style="font-size: 1.5em; margin-top: 0.3em; margin-bottom:0.3em;  height: 3px; background-color: #339CCB">
	</div>
...
%> 
	...
	<div align="center">
	<input type="submit" style="border: outset; background-color: #C6DEFF;width: 165px;" name="ReviseProInvoice" value=" Revise ProForma Invoice " />
	</div>		
	</br>
	</br>
	</br>
