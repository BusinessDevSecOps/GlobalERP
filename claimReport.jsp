...
{
	SumOfAmt=0;
	String SqlClaimDet="Select SUM(Amount) from "+session.getAttribute("CompanyMasterID").toString()+"claim_det where CLMRefNumber='"+rsClaim.getString("CLMRefNumber")+"' and Cancel='1'";
...
if(enter=="null" || enter.equalsIgnoreCase(null))
{
 ...
 %>
 <%String behalf=rsClaim.getString("Behalf");
...
<td width="8%" align="left"><div align="left"><font size=2 color="black"><%=rsClaim.getString("UploadBill")%></font></div></td>
