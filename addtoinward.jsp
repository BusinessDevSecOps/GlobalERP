...
<%@page import="org.apache.log4j.Category"%><%@page import="java.util.Date"%>
...
try{	
	...
	Statement stleave3=conn.createStatement();
		...
		String check="select * from db_leaveapplication."+session.getAttribute("CompanyMasterID").toString()+"inwarddetails where Subject='"+subject.replaceAll("'"," ")+"' and Category='"+category.replaceAll("'"," ")+"' and BillDueDate='"+billduedate.replaceAll("'"," ")+"' ";
		...
		if(rscheck.next())
		{
			...
			String update="Update db_leaveapplication."+session.getAttribute("CompanyMasterID").toString()+"inwarddetails SET Subject='"+subject.replaceAll("'"," ")+"',Category='"+category.replaceAll("'"," ")+"' ,BillDueDate='"+billduedate+"',FromParty='"+from.replaceAll("'"," ")+"',Address='"+address.replaceAll("'"," ")+"',BillNo='"+billno+"',BillAmt='"+amount+"',BillDate='"+billdate+"' where InwardRefNo='"+inwrdno+"'";
