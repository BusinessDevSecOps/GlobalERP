...
<table width="100%" border="0">
		<tr>
							...
							<td align="left" style="width: 250px;" width="25%">
...
<div id="count" style="font-size: 1.3em; text-align:left;">
Uploaded Documents :<a href="#" onclick="popUp()"><%=a%></a>
</div>
<br>
...
<table width="100%" border="0" align="center">
		<tr>
			<td>
							...
							<div style="text-align: right"><font size="1">&nbsp;&nbsp;&nbsp;<%=new java.util.Date()%></font><a href="#" style="font-weight: bold; color: black; " onclick="gotoExcel('table1','tableHTML');">
                           <img src="images/excel.jpg" width="15px" height="15px" style="border-style: none"></img></a><a href="#" onclick="window.print();return false;" title="Print"><img src="images/print.jpg" width="15px" height="15px" style="border-style: none"></img></a></div>
        	</td>
		</tr>
...
<% 
		...
		String trans = "";
		String sqltrans = "select * from "+session.getAttribute("CompanyMasterID").toString()+"fv_erp_relation where ERPCustName = '"+request.getParameter("companyName")+"'";
		...
		System.out.println ("Transporter is ===>"+trans);
				int j = 0;
				String sqlDetails1 = " SELECT * FROM db_CustomerComplaints."+session.getAttribute("CompanyMasterID").toString()+"callinformation where Transporter = '"+trans+"' and TheDate between '"+fromDate+"' and '"+toDate+"' order by TheDate desc ";
				System.out.println(sqlDetails1);
				ResultSet rsDetails1 = stconn1.executeQuery(sqlDetails1);
				while (rsDetails1.next()) {
					%>
<tr>
					<td align="left"><div align ="right"><%=++j %></div></td>
					<td align="right"><div align ="right"><%= new SimpleDateFormat("dd-MMM-yyyy HH:mm").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(rsDetails1.getString("TheDate").trim()+ " "+ rsDetails1.getString("TheTime").trim()))  %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("Reciever") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("Caller") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("Callinfo") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("Transporter") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("CallType")%></div></td>
					<td><div align ="left"><%=rsDetails1.getString("CallerType") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("reasonOfCall") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("vehicleTracking") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("FleetView") %></div></td>
					<td><div align ="left"><%=rsDetails1.getString("salesFollowup")%></div></td>
				...
				if(j==0){
					%>						<tr><td colspan="12">***</td></tr>
											<tr><td colspan="12"><b><%=request.getParameter("companyName") %>
					 						&nbsp;&nbsp;is not followed up since <u><%=fromDateCal %></u> &nbsp;to&nbsp;  <%=toDateCal %></u></b></td></tr>
