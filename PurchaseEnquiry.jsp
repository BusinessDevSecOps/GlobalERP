...
<%
	   ...
	   fromDateCal=new SimpleDateFormat("dd-MMM-yyyy").format(today);
	     ...
	     try{ 
			...
			"	CREATE  TABLE IF NOT EXISTS "+session.getAttribute("CompanyMasterID").toString()+"tmp_" +session.getAttribute("CompanyMasterID").toString() + session.getAttribute("EmpName").toString().replaceAll(" ","_").replace(".","") + " ( " +
...
<br>
<form name='purchaseDetails' action="insertPurchaseEnquiry.jsp?export=No" onsubmit="return validate();" method="post" >
