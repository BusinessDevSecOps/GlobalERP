...
int counter=0;
 ...
 " order by ItemCode) limit 0,"+limitcnt+" ";   
  ...
  String buffer="<div style='height:100%;width:100%;overflow:auto; align:right;'><table align = 'left' border='0'><th></th><th align='left'>Search Item</th><th align='center'>GroupCode</th><th align='center'>GroupName</th><th align='center'>MakeCode</th>"+
