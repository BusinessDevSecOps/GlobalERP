...
<%
 	...
 	st2.executeUpdate(Update);
 		...
 		else
 		{
 		 ...
 		 InsertHistory="insert into db_GlobalERP.100000ReAllocationHistory (CompanyName,CustomerCode,ReAssignedTo,EntryBy,EntryDate) values ('"+CompanyName+"','"+count[h]+"','"+representativecode+"','"+Name+"','"+fromDateCal1+"')";
