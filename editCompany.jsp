...
%>
	<div
		style="font-size: 1.8em; text-align: center; margin-top: 1.0em; margin-bottom: 1.0em;">Edit :  
	<a> <%=rs.getString("CompanyName") %></a></div>
	
<form name="addCustomer" method="post" action="updateCustomer.jsp"
