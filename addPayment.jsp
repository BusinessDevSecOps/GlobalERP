...
function showPaymentModeDetails(){
	...
	function showInvoiceTable()
	{
		...
		document.getElementById('invoiceTable').innerHTML='<table> <tr><td>.</td></tr><tr><td><b>GETTING DATA...</b></td></tr></table>';
			...
			ajaxRequest.open("GET", "AjaxGetInvoiceDetails.jsp" + queryString, true);
...
function showVisitingCardDetails(companyName) {
	...
	<table>
		<tr>
			<td align="left"><a href="http://www.transworldcompressor.com/"> <img
				src="images/transworld.jpg" height="70" width="280"></img> </a></td>
			<td>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td>

			<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td><img src="images/erp.jpeg" height="45" width="170"></img></td>
		</tr>
	</table>
	</div>
	<div id="menu">
	...
	<div id="dropmenu1" class="dropmenudiv"><a
		...
		href="ledgerdetails.jsp">Ledger A/c Details</a> </div>
...
<br>
<div>
<form name="paymentDetails" method="get" action="insertPayment.jsp" onSubmit="return validate();">
...
<%} %>
 ...
 <input type="text" name="availBal" id="availBal" style="border: none;" value="0" readonly="readonly"></input>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				...
				<td>
		<input type="radio" name="invoice" value="invoice" onchange="showInvoiceTable()">Invoice Number Will Be Specified </input>
		...
		<input type="text" name="ddNumber" value="" id="search-text" />
					...
					<td>
		<input type="radio" name="invoice" checked="checked" onclick="" value="notForInvoice" onchange="hideInvoiceTable()">Not For specific Invoice </input>
		</td>
			  ...
			  Calendar.setup(
			    {
			      ...
			      button      : "ddDate"       // ID of the button
							...
							<td>
			<input type="checkbox" name="backDatedEntry" id="backDatedEntry" value="backDatedEntry" onclick="showCalender()"></input>Backdated Entry 
			
											 
			 
						<input type="text" id="fromdate"
						name="fromdate" value="<%=fromDateCal %>" size="15" readonly
						style="visibility:hidden; width: 75px; padding: 4px 5px 2px 5px; border: 1px solid #DEDEDE; background: #FFFFFF; font: normal 11px Arial, Helvetica, sans-serif; background: #C6DEFF" />
		...
		<input type="checkbox" name="deduction" id="deduction" value="deduction" onclick="showTextBox()" > 
		</input> Deduction &nbsp;&nbsp;&nbsp;
				<select name="deductionOptions" id="deductionOptions"
		 style="width: auto; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; 
