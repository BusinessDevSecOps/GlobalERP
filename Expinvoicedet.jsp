...
var curtyp=document.getElementById("CurrTP").value;
	...
	return checkword(finalcal,curtyp);

}

function checkword(finalcal,curtyp)
{
...
String currT="",currS="";
		...
		String sqlcu="select * from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"currencydet where CurrencyType='"+request.getParameter("currT")+"'";
...
if (rsDet.next()) 
{
	currT=rsDet.getString("CurrType");
	...
	Export Order Of :<%=rsDet.getString("SalesorderRefNo")%>  For : <%=rsDet.getString("CompanyName")%></font>
	</div>
	
	
	<form name="generateInvoice" method="get" action="ExpinsertInvoice.jsp" onSubmit="return validate();">
	<br></br>
	 ...
	 <td style="width: 35%">
	 	...
	 	<div class="TabView" id="TabView">
			...
			<div class="Pages" style="width: 650px; height: 135px;">
			<div class="Page">
			<div class="Pad">
				...
				<td><font face="Arial" size="2" color="black"><%=new SimpleDateFormat(
								...
								.format(new SimpleDateFormat( 
										"yyyy-MM-dd")
										.parse(rsDet.getString("SalesOrderDate")))%></font></td>
				<td> <font face="Arial" size="2" color="black"><b>SO Time:</b></font></td>
				<td><font face="Arial" size="2" color="black"><%=rsDet.getString("SalesOrderTime") %></font></td>
				</tr>
				<tr>
				...
				<tr>
				<td><font face="Arial" size="2" color="black"><b>Customer SO No :</b></font></td>
				<td><font face="Arial" size="2" color="black"><%= rsDet.getString("CustSalesOrderNo") %>
				</td>
...
KoregaonPark,Pune-411001</textarea>
	...
	<td style="width: 65%;height: 50%">
	
	<input type="hidden" name="customercode" value="<%=rsDet.getString("CustomerCode")%>"/>
	
	
	
		<table  bgcolor="#C6DEFF" align="right" style="width: 100%;height: 100%" border="0" valign="top" cellpadding="3" cellspacing="3" >
		<tr>
...
%>
	 	...
	 	<input type="hidden" id="CurrTP" name="CurrTP" value="<%=currT %>" />
...
<br>
	...
	<div style="font-size: 1.0em" align="right">
	 ...
	 <b>Total:</b>&nbsp;&nbsp; &nbsp;&nbsp;
	 <input type="text" readonly="readonly" name="total" id="total" style="width: 75px; border: none;" value=""/>
	 &nbsp;&nbsp;&nbsp;&nbsp;
	</div>
	...
	<font face="Arial" size="2" color="black"> <b>Grand Total :</b></font> &nbsp;&nbsp;
	<input type="text" readonly="readonly"  name="grandTotal" id="grandTotal" 
	...
	value="Save Proforma Invoice" style="border: outset; background-color: #C6DEFF; width: 170px; " />
	</div>
	<%}else if(type.equalsIgnoreCase("main")) {%>
	<div align="right"  >
		<input type="submit"  name="submitOrder"
	value="Save Sales Invoice" style="border: outset; background-color: #C6DEFF; width: 170px; " />
	</div>
	<%} %>
