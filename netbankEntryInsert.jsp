...
try{
  ...
  System.out.println("222");
   ...
   String sqlinsert="Insert into "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords (Recordmatter,BeneficiaryName,BeneficiaryAccountNumber,IFCCode,BeneBankName,BeneBankBranchName,Beneficiaryemailid,Amount,TallyRefNo,Comments,Createdby,CreationDate,RecordType,FileName1)"+
   			"values ('"+Stringtocreatefile+"','"+benfName+"','"+accountNo+"','"+ifcCode+"','"+benfBankName+"','"+branchname+"','"+email+"','"+amount+"','"+refNo+"','"+comment+"','"+EmpName+"','"+todaysDateTime+"','"+tranType+"','NA')";
	/*
