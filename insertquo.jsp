...
//	response.sendRedirect("alertGoTo.jsp?msg=Record Saved Succesfully.&goto=home.jsp");
	...
	response.sendRedirect("alertGoTo.jsp?msg=Sales Quotation added successfully with Ref NO :"+salesquorefno+" For Company "+company1+".This will redirect you to print Quotation .&goto=printsalesquotation.jsp?salesQuotation="+squono+"");
	}
	catch(Exception e)
	{
