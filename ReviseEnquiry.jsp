...
<%      
	...
	{	
		...
		if(no< 5)
		{
			tableToBeAccessed="tbl_"+group.substring(0,5).toLowerCase()+"im_make"+makecode1+"";
		}
		else 
		...
		response.sendRedirect("alertGoTo.jsp?msg=Sales Enq Revised successfully &goto=salesEnqReport.jsp");
