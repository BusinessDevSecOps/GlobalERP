	...
	if(id.contains("group"))
	{
		...
		String sqlGrpMasterNew="CREATE TABLE IF NOT EXISTS "+session.getAttribute("CompanyMasterID").toString()+"tbl_"+Gname.substring(0,5).toLowerCase()+"makemaster"+"( "+
		 ...
		 System.out.println("INSERT NEW MAKE   masetrrrr "+sqlGrpMasterNew);
	         ...
	         {
	         	  String sql1="insert into "+session.getAttribute("CompanyMasterID").toString()+"tbl_groupmaster (TheGroupName)values('"+Gname+"')";
	         	  ...
	         	  String sqlItems="Insert into "+session.getAttribute("CompanyMasterID").toString()+"searchitems (groupcode ,GroupName,makecode ,makename ,makedettable ,ItemCode ,Model ,PartNo ,Description ,Price ,pricedate)"+
     ...
     {	
    	 	...
    	 	int a=0;  String make=""; 	String getcode=""; 	 
 			...
 			//else
		 	{
  	 		 ...
  	 		 System.out.println("INSERT NEW MAKE   masetrrrr "+sqlGrpMaster);
		    	 	...
		    	 	else
		    	 	{
		        	 	...
		        	 	String sqlInsert="Insert into "+session.getAttribute("CompanyMasterID").toString()+"tbl_"+grname.substring(0,5).toLowerCase()+"makemaster (MakeName) Values ('"+newmake+"')";
		    	 		...
		    	 		ResultSet rsgetcd=st1.executeQuery(sqlGetCode);
		    	 		System.out.println(">>  "+sqlGetCode);
		    	 		rsgetcd.next();
		    	 		getcode=rsgetcd.getString("MakeCode");
		    	 		System.out.println(">>  "+getcode);
		    	 		System.out.println("********************************* 8888888888 ");
		    	 		String sqlNewMake="CREATE TABLE IF NOT EXISTS "+session.getAttribute("CompanyMasterID").toString()+"tbl__"+grname.substring(0,5).toLowerCase()+"make"+getcode+"( "+
