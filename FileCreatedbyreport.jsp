...
%>
	...
	<a>File Created By Report</a></div>

<form>

<table width="70%" border="0" align="center">
		<tr align="center">
	<!-- 	<td align="left" style="width: 10px;"><b>Entered By</b></td><td align="left"  style="width: 80px;">
...
<td valign="top" align="right" width="25%">
					<div id='repName'>
										 ...
										 <b>File Created By Name </b></td><td valign="top" align="left" width="25%"><select
...
try 	
{
	...
	{
		sql1="Select * from "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords where   FileCreationDatetime between '"+fromDate+" 00:00:00' and '"+toDate+" 23:59:59'";
	}
	else
	{
		sql1="Select * from "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords where  FileCreatedby='"+selectedName+"' and FileCreationDatetime between '"+fromDate+" 00:00:00' and '"+toDate+" 23:59:59'";
	}
...
{
	sql1="Select * from "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords where  FileCreatedby='"+user+"' and FileCreationDatetime between '"+fromDate+" 00:00:00' and '"+toDate+" 23:59:59'";
}
System.out.println("creation Query===>"+sql1);
...
<td><div align="left"><%=rsdata.getString("BeneficiaryAccountNumber") %></div> </td>
...
<td><div align="left"><%=rsdata.getString("CreationDate") %> </div></td>
<td><div align="left"><%=rsdata.getString("RecordStatus") %> </div></td>
<td><div align="left"><%=rsdata.getString("FileCreatedby") %> </div></td>
